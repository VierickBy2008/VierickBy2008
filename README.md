...
Siempre busco aprender de forma estructurada e ir documentando mi proceso paso a paso, desde los conceptos más básicos hasta sistemas más complejos.
...
**Lenguajes:**
* C++ (Mi herramienta principal para lógica y control de flujo)
* Python
* Java
* Octave
* HTML
...
* JetBrains
* Git / GitHub
* PseInt (Para estructurar el pseudocódigo antes de picar código)

### 📂 Proyectos Destacados

* **[Aquí puedes poner el link a tu repositorio de la Calculadora de Notas]** - Sistema robusto en C++ para calcular promedios universitarios (Cálculo 3) con validaciones de rangos y manejo de errores.
* **[Link a tu evaluador de sueño]** - Algoritmo con condicionales anidados que evalúa hábitos de salud en base a la edad del usuario.
* **[Link a tu validador de decimales]** - Ejercicio de control de flujo estricto utilizando ciclos `while` infinitos y *casting* de variables.
